...
**Files:**
- Create: `packages/claude-code/src/**` (from `docs/claudecode-research/sources/claude-code/src/**`)

- [ ] **Step 1: Copy all source files from mirror to new package**
Run: `cp -r docs/claudecode-research/sources/claude-code/src/* packages/claude-code/src/`
