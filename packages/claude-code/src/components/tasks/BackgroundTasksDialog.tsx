...
const workflowTaskModule = feature('WORKFLOW_SCRIPTS') ? require('src/tasks/LocalWorkflowTask/LocalWorkflowTask') as typeof import('src/tasks/LocalWorkflowTask/LocalWorkflowTask') : null;
